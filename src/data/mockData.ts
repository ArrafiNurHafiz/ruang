...
export const INITIAL_TOKENS = MOCK_SCHOOL_TOKENS;
...
> = {
  ...
  admin: {
    ...
    permissions: [
      "Kelola Pengguna Nasional",
      "Audit Log Sistem",
      "Konfigurasi & Cadangan Data",
      "Sinkronisasi Satuan Pendidikan",
    ],
  },
  "dinas-pendidikan": {
    id: "usr-disdik-01",
...
export const MOCK_REGIONAL_SCHOOLS: SchoolRegionalData[] = [
  ...
  },
  {
    ...
    complianceStatus: "Patuh (A)",
    principalName: "Drs. Sugeng Raharjo, M.Pd",
    lastActive: "35 menit lalu",
    hotlineNumber: "0812-1199-004",
  },
  {
    id: "sch-05",
    ...
    complianceStatus: "Patuh (A)",
    principalName: "Drs. Bambang Sudaryanto",
    lastActive: "15 menit lalu",
    hotlineNumber: "0812-1199-005",
  },
  {
    id: "sch-06",
    ...
    complianceStatus: "Cukup (B)",
    principalName: "Dra. Hj. Elfi Sahara, M.Si",
    lastActive: "2 jam lalu",
    hotlineNumber: "0812-1199-006",
  },
  {
    id: "sch-07",
    ...
    complianceStatus: "Patuh (A)",
    principalName: "Drs. Syahruddin, M.Pd",
    lastActive: "40 menit lalu",
    hotlineNumber: "0812-1199-007",
  },
  {
    id: "sch-08",
    ...
    complianceStatus: "Patuh (A)",
    principalName: "I Made Raka, S.Pd., M.Pd",
    lastActive: "1 jam lalu",
    hotlineNumber: "0812-1199-008",
  },
  {
    id: "sch-09",
    schoolName: "SMK Negeri 1 Balikpapan",
    npsn: "30401490",
    ...
    principalName: "Drs. Mujadi, M.Pd",
    lastActive: "4 jam lalu",
    hotlineNumber: "0812-1199-009",
  },
  {
    id: "sch-10",
